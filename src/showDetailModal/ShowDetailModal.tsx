      ...
      {player &&(
        ...
        onClick={()=>onClose()}
         className='fixed left-0 top-0 bg-app-background bg-opacity-50 z-30 w-screen h-screen flex items-center justify-center'>
          ...
          <div
            onClick={(e) => e.stopPropagation()} // para evitar cerrar al clickear adentro
            className="relative w-80 text-white flex flex-col bg-app-boxes p-4 rounded-md"
          >
            ...
            <svg
              ...
              height="22"
              fill="currentColor"
              className="bi bi-x-lg cursor-pointer absolute top-5 right-3 hover:scale-110 transition-transform"
              viewBox="0 0 16 16"
            >
            ...
            <header className="mb-4">
              <h3 className="text-2xl text-center font-semibold text-white">Ver jugador</h3>
            </header>
